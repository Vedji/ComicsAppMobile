    ...
    Scaffold(
        ...
        topBar = {
                TopAppBar(
                    ...
                    navigationIcon = {
                        IconButton(
                            onClick = { }, // TODO: Add open navigation
                        ) {
                            Icon(
                                Icons.Default.Menu,
                                "Menu",
            ...
            Column(modifier = Modifier
                ...
                OutlinedCard(
                    ...
                    SecondaryScrollableTabRow(
                        ...
                        divider = { HorizontalDivider(thickness = 3.dp, color = MaterialTheme.colorScheme.outline) },
                    ...
                    when(state){
                        0 -> { ProfileFavoriteBooksTab(navController = navController, profileViewModel = profileViewModel) }
                        1 -> { ProfileCommentsTab(navController = navController, profileViewModel = profileViewModel) }
                        2 -> { ProfileAddedBooksTab(navController = navController, profileViewModel = profileViewModel) }
